...
//creat two bord view object
        ...
        BordType Darr =new CellButton(data);
        BordType Darr2 =new AnimatedCellButton(data);
        ...
        final Thread boredFrame = new Thread(new Runnable() {          
            public void run() {
                ...
                for (int n = 0; n < 3; n++) {
                    ...
                    if(bordType == 2) {
                        frame.add(Darr2.getButtons()[n][i]);             
                        }                              
                    }}
                frame.pack();
              ...
              try {  
                  ...
                  bordType1.addActionListener(new ActionListener() {
                      public void actionPerformed(ActionEvent e) { 
                          ...
                          bordType2.repaint();
                          bordType=1;
                          data.addObserver((Observer) Darr);
                          Darr.getPlayer1().name=name1.getText();
                          Darr.getPlayer2().name=name2.getText();
                  ...
                  bordType2.addActionListener(new ActionListener() {
                      public void actionPerformed(ActionEvent e) {  
                          ...
                          bordType1.repaint();
                          bordType=2;
                          data.addObserver((Observer) Darr2);
                          Darr2.getPlayer1().name=name1.getText();
                          Darr2.getPlayer2().name=name2.getText();
